...
import os
token = '7913688458:AAGltdLCRLgLVzpp16vgc2ei2Sh9X4eDsic'
bot=telebot.TeleBot(token,parse_mode="HTML")
subscriber = '7492788024'
@bot.message_handler(commands=["start"])
def start(message):
	if not str(message.chat.id) == '7492788024':
		bot.reply_to(message, "You cannot use the bot to contact developers to purchase a bot subscription @Ur_Fav_WangLinn5")
		return
